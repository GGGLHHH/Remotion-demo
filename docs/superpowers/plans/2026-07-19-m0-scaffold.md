...
export default function App() {
  ...
  return (
    <div className="flex flex-col bg-zinc-900 text-zinc-100 block-screen">
      <header className="
        flex shrink-0 items-center border-be border-zinc-800 px-4 text-sm
        block-12
      "
      >
        Remotion Editor
      ...
      <div className="flex flex-1 min-block-0">
        <main className="
          flex flex-1 items-center justify-center bg-zinc-950 p-8 min-inline-0
        "
        >
          <Player
        ...
        <aside className="
          shrink-0 border-s border-zinc-800 p-4 text-sm text-zinc-400 inline-72
        "
        >
          Inspector（M1）
        </aside>
      ...
      <footer className="
        shrink-0 border-bs border-zinc-800 p-4 text-sm text-zinc-400 block-56
      "
      >
        Timeline（M2）
      </footer>
