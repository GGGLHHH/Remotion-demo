  ...
  <>
    ...
    {guideFrame !== null
      ? (
          <div
            className="
              pointer-events-none absolute inset-y-0 z-30 bg-muted-foreground
              inline-px
            "
    ...
    {moveVisual && moveVisual.thresholdFrame !== null
      ? (
          <div
            className="
              pointer-events-none absolute inset-y-0 z-30 border-s border-dashed
              border-amber-400/80
            "
    ...
    {dropHint
      ? (
          <>
            <div
              className="
                pointer-events-none absolute inset-y-0 z-20 bg-blue-400
                inline-px
              "
            ...
            {dropHint.trackIndex >= 0 && dropHint.trackIndex < undoable.tracks.length
              ? (
                  <div
                    className="
                      pointer-events-none absolute inset-x-0 z-10 bg-blue-400/10
                    "
                    style={{
    ...
    {marqueeRect
      ? (
          <div
            className="
              pointer-events-none absolute z-10 border border-blue-400
              bg-blue-400/10
            "
            style={{
              left: marqueeRect.x,
