...
export const TimelineToolbar: React.FC<{
  ...
  return (
    <div className="
      flex items-center gap-3 border-be border-border px-3 text-xs
      text-muted-foreground block-8
    "
    >
      ...
      <Tooltip>
        ...
        >
          <Magnet className="block-4 inline-4" />
        </TooltipTrigger>
      ...
      <Tooltip>
        ...
        >
          <Scissors className="block-4 inline-4" />
        </TooltipTrigger>
      ...
      >
        <Minus className="block-3 inline-3" />
      </Button>
      <div className="inline-32">
        <Slider
          min={0}
          max={1}
          step={0.01}
      ...
      <Button
        ...
        onClick={() => setZoom(zoom * 2)}
      >
        <Plus className="block-3 inline-3" />
      </Button>
      <Button
        variant="ghost"
        size="xs"
        className={zoomSetting === 'fit'
          ? `
            text-blue-400
            hover:text-blue-400
          `
