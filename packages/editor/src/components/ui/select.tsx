    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(`
            relative isolate z-50 origin-(--transform-origin) overflow-x-hidden
    ...
    <SelectPrimitive.Item
      ...
      className={cn(
        `
          ...
          ps-1.5 pe-8 text-sm outline-hidden select-none inline-full
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn('pointer-events-none -mx-1 my-1 bg-border block-px', className)}
      {...props}
    />
  )
}
...
function SelectScrollUpButton({
  className,
  ...props
}: React.ComponentProps<typeof SelectPrimitive.ScrollUpArrow>): ReactElement {
  return (
    <SelectPrimitive.ScrollUpArrow
      data-slot="select-scroll-up-button"
      className={cn(
        `
          inset-bs-0 z-10 flex cursor-default items-center justify-center
          bg-popover py-1 inline-full
          [&_svg:not([class*='size-'])]:block-4
          [&_svg:not([class*='size-'])]:inline-4
        `,
        className,
...
function SelectScrollDownButton({
  className,
  ...props
}: React.ComponentProps<typeof SelectPrimitive.ScrollDownArrow>): ReactElement {
  return (
    <SelectPrimitive.ScrollDownArrow
      data-slot="select-scroll-down-button"
      className={cn(
        `
          inset-be-0 z-10 flex cursor-default items-center justify-center
          bg-popover py-1 inline-full
          [&_svg:not([class*='size-'])]:block-4
          [&_svg:not([class*='size-'])]:inline-4
        `,
