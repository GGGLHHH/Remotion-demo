...
function pushPast(past: UndoableState[], snapshot: UndoableState): UndoableState[] {
...
export function createHistorySlice(set: EditorSet, get: EditorGet, init?: EditorInitialState): Pick<
  EditorStore,
  | 'undoable'
  | 'past'
  | 'future'
